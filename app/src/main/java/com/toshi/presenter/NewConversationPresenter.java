...
public final class NewConversationPresenter implements Presenter<NewConversationActivity> {
    ...
    @Override
    public void onViewAttached(final NewConversationActivity view) {
        this.activity = view;
    ...
    public void initShortLivingObjects() {
        setGroupChatViewVisibility();
        initClickListeners();
        initRecyclerView();
        initSearch();
    }

    private void setGroupChatViewVisibility() {
        this.activity.getBinding().newGroup.setVisibility(BuildConfig.DEBUG ? View.VISIBLE : View.GONE);
    }
